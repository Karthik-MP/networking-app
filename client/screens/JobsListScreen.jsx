...
import { collection, getDocs, orderBy, limit, query, where, startAfter } from 'firebase/firestore';
...
export default function JobsListScreen({ navigation }) {
  ...
  if (loading) {
    return <View className="p-4"><ActivityIndicator /></View>;
  }
  ...
  return (
    <FlatList
      ...
      refreshControl={<RefreshControl refreshing={loading} onRefresh={loadInitial} />}
    />
  );
}
